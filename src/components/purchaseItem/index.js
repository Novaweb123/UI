...
onKeyDown={
    ((e)=>{
        ...
        if(e.key != "Backspace" || e.key != "Meta" || e.key != "Tab"){
            ...
            formik.setFieldValue('Item_name',{ id:e.target.value, label: e.label })
...
onChange={((e)=>{
    formik.setFieldValue('Item_name',{ value:e.value, label: e.label })
    formik.setFieldValue('Quantity',1);
...
/>
                                        ...
                                        <td width="10%">
                                            <Select
                                                    ...
                                                    options={props.dropdownsData?.data.product_category}
                                            />
                                        </td>
